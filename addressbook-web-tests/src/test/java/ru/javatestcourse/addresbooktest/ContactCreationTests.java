...
public class ContactCreationTests {
  ...
  public void testContactCreationTests() throws Exception {
    ...
    driver.findElement(By.name("lastname")).sendKeys("Alexx");
    driver.findElement(By.name("address")).click();
    driver.findElement(By.name("address")).clear();
    driver.findElement(By.name("address")).sendKeys("Ru, Spb");
    driver.findElement(By.name("home")).click();
    driver.findElement(By.name("home")).clear();
    driver.findElement(By.name("home")).sendKeys("123456789");
    driver.findElement(By.name("email")).click();
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("test@qa.com");
